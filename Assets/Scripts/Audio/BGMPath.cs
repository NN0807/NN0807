...
{
    public const string CustomizeBGM = "Assets/Resources/BGM/CustomizeBGM.wav";
    public const string FireStageBGM = "Assets/Resources/BGM/FireStageBGM.wav";
    public const string GimmickStageBGM = "Assets/Resources/BGM/GimmickStageBGM.wav";
