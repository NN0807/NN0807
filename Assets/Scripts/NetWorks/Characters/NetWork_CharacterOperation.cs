...
public class NetWork_CharacterOperation : MonoBehaviour
{
    // 入力処理
    [SerializeField]
    ...
    public void OperationUpdate(NetWork_CharacterManager manager)
    {
        // フラグ更新
    ...
    public void RegisterColliderEvent(NetWork_CharacterCollider collider)
    {
        // イベントに関数を登録
