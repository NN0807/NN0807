...
public class CharacterModel : MonoBehaviour
{
    ...
    public void GenerateAndRegisterParts(CharacterManager manager, int characterNumber)
    {
        ...
        var _bodyNumber   = characterNumber == 0 ? PlayerPrefs.GetInt("body",  0) : Random.Range(0, 8);
        var _legNumber    = characterNumber == 0 ? PlayerPrefs.GetInt("leg",   0) : Random.Range(0, 8);
        var _weaponNumber = characterNumber == 0 ? PlayerPrefs.GetInt("punch", 0) : Random.Range(0, 8);
