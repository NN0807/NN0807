...
public class Ranking_CharacterManager : MonoBehaviour
{
    // モデルスクリプト
    [SerializeField]
    public Ranking_Character_Model _ranking_Character_Model;
    ...
    void Start()
    {
        ...
        _ranking_Character_Model?.GenerateAndRegisterParts(this, Number);
    }
